...
#   trained model on some training_images then you can run the
...
# training_images in the training dataset and also contains the positions of the face
# parts.
...
# Now let's run the detector and shape_predictor over the training_images in the faces
# folder and display the results.
print("Showing detections and predictions on the training_images in the faces folder...")
