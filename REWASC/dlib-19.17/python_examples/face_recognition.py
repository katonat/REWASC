...
#   an image of a human face to a 128 dimensional vector space where training_images of
#   the same person are near to each other and training_images from different people are
...
#   training_images, the tool will correctly identify if the pair belongs to the same
...
# Now process all the training_images
