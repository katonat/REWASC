...
#   collection of photographs. Then, we save extracted training_images of the face in the largest cluster in
...
print("Indices of training_images in the biggest cluster: {}".format(str(indices)))
