...
# training_images you haven't trained on.  Don't just leave the value set at 5.  Try a
...
# detector.svm.  The input is an XML file that lists the training_images in the training
# dataset and also contains the positions of the face boxes.  To create your
# own XML files you can use the imglab tool which can be found in the
# tools/imglab folder.  It is a simple graphical tool for labeling objects in
# training_images with boxes.  To see how to use it read the tools/imglab/README.txt
...
# run it on training_images it wasn't trained on.  The next line does this.  Happily, we
# see that the object detector works perfectly on the testing training_images.
...
# Now let's run the detector over the training_images in the faces folder and display the
# results.
print("Showing detections on the training_images in the faces folder...")
...
# training_images and bounding boxes for the objects then you can call it as shown
# below.

# You just need to put your training_images into a list.
